...
while($row = mysqli_fetch_assoc($query)) {
        echo "<tr style='height: 50px'><td>" . $row["id"]. "</td><td>" . $row["name"]. " </td><td>" . $row["lname"]." </td><td>" . $row["explorer"]." </td><td>" . $row["tel"]." </td><td>" . $row["datat"]." </td><td>" . $row["gjinia"]." </td><td>" . $row["vendi"]." </td><td>" . $row["niveli"]." </td><td>" . $row["gpa"]. " </td><td>" . $row["course"]." </td><td>" . $row["explorer"]."</td></tr>";
    }
echo"</table>";
?>
